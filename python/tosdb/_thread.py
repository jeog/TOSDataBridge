...
from . import VTOSDB_DataBlock, DEF_TIMEOUT, MAX_STR_SZ, STR_DATA_SZ
from .doxtend import doxtend as _doxtend

from threading import RLock as _RLock

class VTOSDB_DataBlockThreadSafe(VTOSDB_DataBlock):
    """ The main object for storing TOS data with thread-safe access (VIRTUAL)
    ...
    @_doxtend(VTOSDB_DataBlock) # __doc__ from VTOSDB_DataBlock
