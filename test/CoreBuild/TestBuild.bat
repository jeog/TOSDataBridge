...
IF "%1"=="x86" (
    ...
    set "OURlibstub=!RELdir!\Win32\tos-databridge-0.6-x86.lib"
    set "OURdllname=tos-databridge-0.6-x86.dll"
    ...
    IF "%1"=="x64" (
        ...
        set "OURlibstub=!RELdir!\x64\tos-databridge-0.6-x64.lib"
        set "OURdllname=tos-databridge-0.6-x64.dll"
