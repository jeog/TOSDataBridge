...
#define TOSDB_ERROR_TIMEOUT -4
#define TOSDB_ERROR_BLOCK_ALREADY_EXISTS -5
#define TOSDB_ERROR_BLOCK_DOESNT_EXIST -6
#define TOSDB_ERROR_BLOCK_CREATION -7
#define TOSDB_ERROR_BLOCK_SIZE -8
#define TOSDB_ERROR_BAD_TOPIC -9
...
public:
    ...
    YIELD = 0x152,
    CUSTOM1 = 0x201 | ADJ_STRING_BIT,    
    CUSTOM2 = 0x202 | ADJ_STRING_BIT,
    CUSTOM3 = 0x203 | ADJ_STRING_BIT,    
    CUSTOM4 = 0x204 | ADJ_STRING_BIT,    
    CUSTOM5 = 0x205 | ADJ_STRING_BIT,    
    CUSTOM6 = 0x206 | ADJ_STRING_BIT,    
    CUSTOM7 = 0x207 | ADJ_STRING_BIT,    
    CUSTOM8 = 0x208 | ADJ_STRING_BIT,    
    CUSTOM9 = 0x209 | ADJ_STRING_BIT,    
    CUSTOM10 = 0x20a | ADJ_STRING_BIT,    
    CUSTOM11 = 0x20b | ADJ_STRING_BIT,    
    CUSTOM12 = 0x20c | ADJ_STRING_BIT,   
    CUSTOM13 = 0x20d | ADJ_STRING_BIT,    
    CUSTOM14 = 0x20e | ADJ_STRING_BIT,   
    CUSTOM15 = 0x20f | ADJ_STRING_BIT,   
    CUSTOM16 = 0x210 | ADJ_STRING_BIT,    
    CUSTOM17 = 0x211 | ADJ_STRING_BIT,    
    CUSTOM18 = 0x212 | ADJ_STRING_BIT,    
    CUSTOM19 = 0x213 | ADJ_STRING_BIT
